...
class Map(object):
    ...
    def __init__(self, origin_x=None, origin_y=None, resolution=None,
                 width=None, height=None,basis=None,occupancy_grid=None):
        ...
        if basis != None:
            ...
            self.grid = np.array(occupancy_grid.data).reshape((self.height/self.resolution, self.width/self.resolution))
        else:
