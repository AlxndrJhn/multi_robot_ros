...
if("TRUE" STREQUAL "TRUE")
  set(epuck_driver_SOURCE_PREFIX /home/alexj/Dropbox/UFMG/04-2-2016/JornalPaper/02-code/03-ros_ws_latpop_new/src/epuck_driver)
  set(epuck_driver_DEVEL_PREFIX /home/alexj/Dropbox/UFMG/04-2-2016/JornalPaper/02-code/03-ros_ws_latpop_new/devel)
  ...
  set(epuck_driver_INSTALL_PREFIX /home/alexj/Dropbox/UFMG/04-2-2016/JornalPaper/02-code/03-ros_ws_latpop_new/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'epuck_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David Saldana <dajulian@gmail.com>, Ramon Melo <workmelo@gmail.com>, Paulo Rezeck <rezeck@dcc.ufmg.br>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'epuck_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alexj/Dropbox/UFMG/04-2-2016/JornalPaper/02-code/03-ros_ws_latpop_new/src/epuck_driver/${idir}'.  Ask the maintainer 'David Saldana <dajulian@gmail.com>, Ramon Melo <workmelo@gmail.com>, Paulo Rezeck <rezeck@dcc.ufmg.br>' to fix it.")
    endif()
    _list_append_unique(epuck_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "epuck_driver")
...
set(depends "geometry_msgs;rospy;std_msgs;cv_bridge;roscpp;sensor_msgs;tf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${epuck_driver_dep}_FOUND)
      find_package(${epuck_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${epuck_driver_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND epuck_driver_EXPORTED_TARGETS ${${epuck_driver_dep}_EXPORTED_TARGETS})
endforeach()
