...
"""autogenerated by genpy from marker_controller/TargetPose.msg. Do not edit."""
import sys
...
class TargetPose(genpy.Message):
  _md5sum = "fad1eb37fec81628124f156f76d0e4dc"
  _type = "marker_controller/TargetPose"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
